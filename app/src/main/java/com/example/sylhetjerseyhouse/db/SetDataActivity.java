...
public class SetDataActivity extends AppCompatActivity {
    ...
    Uri selectedUri;
    ImageView imageView;
    EditText title, price, description, db_Table;
    Bitmap bitmap;
    Button buttonPickImg, buttonUpload;
    String url = "https://food-buzz.000webhostapp.com/upload_data.php";
    String encodeImage;
    ...
    private void uploadImage() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(SetDataActivity.this, response.toString(), Toast.LENGTH_SHORT).show();
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SetDataActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Nullable
            @Override
