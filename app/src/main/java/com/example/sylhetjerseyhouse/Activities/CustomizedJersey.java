...
public class CustomizedJersey extends AppCompatActivity {

    RecyclerView customizedJerseyRV;
    private Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private Model model;
    private String url = "https://food-buzz.000webhostapp.com/customized_jersey.php";
    private List<Model> dataList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_customized_jersey);

        customizedJerseyRV = findViewById(R.id.id_CustomizedJerseyRV);
        fetchData();
