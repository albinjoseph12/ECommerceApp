...
public class Snakers extends AppCompatActivity {

    RecyclerView snakersRV;
    private Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private Model model;
    private String url = "https://food-buzz.000webhostapp.com/snakers.php";
    private List<Model> dataList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_snakers);

        snakersRV = findViewById(R.id.id_SnakersRV);
