...
public class WinterClothes extends AppCompatActivity {

    RecyclerView winterClothesRV;
    private Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private Model model;
    private String url = "https://food-buzz.000webhostapp.com/winter_clothes.php";
    private List<Model> dataList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_winter_clothes);

        winterClothesRV = findViewById(R.id.id_WinterClothesRV);
        fetchData();
