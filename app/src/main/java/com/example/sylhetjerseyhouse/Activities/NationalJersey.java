...
public class NationalJersey extends AppCompatActivity {

    RecyclerView nationalJerseyRV;
    private Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private Model model;
    private String url = "https://food-buzz.000webhostapp.com/national_jersey.php";
    private List<Model> dataList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_national_jersey);

        nationalJerseyRV = findViewById(R.id.id_NationalJerseyRV);
